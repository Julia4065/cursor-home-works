...
public class Main {
    private static Integer[] originArray = {2, 3, 1, 7, 11};
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Sum of all positive elements in the array: " + arrayModifier.sumOfPositiveElements(originArrayWithPosAndNegElements));

        System.out.println("Task 5");
        System.out.println("Average sum of the list of numbers in array: " + arrayModifier.averageListNumbersOf(originPrimitiveArray));
