...
public class Executor {
    ...
    public void demonstrateLibraryWorking() {
    ...
    public void demonstrateLibraryWorkingWithSingleBook() {
        ...
        libraryReport.takeABook(LocalDate.of(2019, 10, 7), "Book1");
        libraryReport.takeABook(LocalDate.of(2018, 11, 8), "Book2");
        libraryReport.takeABook(LocalDate.of(2017, 12, 9), "Book3");
    ...
    public void demonstrateLibraryWorkingWithMultipleBooks() {
        LibraryReport libraryReport = new LibraryReport();
        libraryReport.takeFewBooks(LocalDate.of(2019, 10, 31), Arrays.asList("Book7", "Book8", "Book9"));
        libraryReport.takeFewBooks(LocalDate.of(2019, 10, 19), Arrays.asList("Book10", "Book11"));
        libraryReport.takeFewBooks(LocalDate.of(2019, 10, 13), Arrays.asList("Book12"));
